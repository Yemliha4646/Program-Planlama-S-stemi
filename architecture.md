...
| Veritabanı | SQLite | İlişkisel veri modeli, sınav ve kart ilişkilerini ACID standartlarında tutmak için tercih edilmiştir. Hafif ve sunucusuz yapısı sayesinde kurulum gerektirmez. |
